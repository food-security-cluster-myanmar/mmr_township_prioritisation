...
From the report Undestanding Conflict in Myanmar: a food Security Perspective. Updated with 2022 data. Link.
...
fs_pin <- read_excel("./data/hpc_pin.xlsx") %>%  
  ...
  mutate(old_group = case_when(
    conflict_score >= mean(conflict_score) & population_density >= 1000 ~ "A1",
